...
from backend.config.config_integration import setup_kimera_logger
...
class AggressiveKimeraTrader:
    ...
    async def force_opportunistic_trade(self, symbols):
        ...
        try:
            ...
            from backend.trading.autonomous_kimera_trader import CognitiveSignal, TradingStrategy, MarketRegime
