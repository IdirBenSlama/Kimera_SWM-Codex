...
async def comprehensive_system_test():
    ...
    try:
        ...
        print(f'   ✅ Memory: {metrics.allocated_memory:.3f}GB/{metrics.total_memory:.1f}GB')
        ...
        # Route some requests
        node1 = await route_cognitive_request('understanding', {'priority': 'high', 'requires_gpu': True})
        ...
        understand_text = "Analyze this complex cognitive integration test with GPU acceleration"
        ...
        print(f'   ✅ Understanding Quality: {understand_result.comprehension_quality:.3f}')
        print(f'   ✅ Consciousness Probability: {consciousness_result["probability"]:.3f}')
        ...
        target_node = await route_cognitive_request('deep_analysis', {
            'priority': 'critical',
            'requires_gpu': True,
    ...
    print(f'\n📊 Platform Status:')
    print(f'  GPU Acceleration: {"✅" if "gpu_acceleration" in test_results and test_results["gpu_acceleration"] == "PASSED" else "❌"}')
    print(f'  Advanced Caching: {"✅" if "advanced_caching" in test_results and test_results["advanced_caching"] == "PASSED" else "❌"}')
    print(f'  Pipeline Optimization: {"✅" if "pipeline_optimization" in test_results and test_results["pipeline_optimization"] == "PASSED" else "❌"}')
    print(f'  Horizontal Scaling: {"✅" if "horizontal_scaling" in test_results and test_results["horizontal_scaling"] == "PASSED" else "❌"}')
    print(f'  Cognitive Capabilities: {"✅" if "cognitive_capabilities" in test_results and test_results["cognitive_capabilities"] == "PASSED" else "❌"}')
    print(f'  Integrated Performance: {"✅" if "integrated_performance" in test_results and test_results["integrated_performance"] == "PASSED" else "❌"}')
