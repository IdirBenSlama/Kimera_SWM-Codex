...
async def test_learning_fixes():
    ...
    try:
        ...
        test1_pass = (learning_result.success and
        ...
        print(f"   First session - Success: {first_result.success}, Integration: {first_result.knowledge_integration:.4f}")
        ...
        print(f"   Second session - Success: {second_result.success}, Integration: {second_result.knowledge_integration:.4f}")
        
        test2_pass = (first_result.success and second_result.success and
