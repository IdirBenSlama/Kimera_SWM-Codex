...
try:
    ...
    from src.core.master_cognitive_architecture import ArchitectureState, ProcessingMode, CognitiveWorkflow
    print("   ✅ Enums imported")
    
    print("   - Importing data classes...")
    from src.core.master_cognitive_architecture import CognitiveRequest, CognitiveResponse
