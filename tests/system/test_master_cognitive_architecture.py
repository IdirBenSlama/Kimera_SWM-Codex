    ...
    try:
        ...
        try:
            ...
            if success:
                ...
                print(f"   Components registered: {len(architecture.component_registry)}")
                ...
                test_results["component_initialization"] = "FAILED: Initialization returned False"
        except Exception as e:
        ...
        try:
            ...
            if status['state'] == 'ready' and status['components']['total'] > 0:
                ...
                test_results["system_status"] = "FAILED: System not ready or no components"
        except Exception as e:
        ...
        try:
            ...
            if response.success and response.quality_score > 0:
                ...
                test_results["basic_cognitive_processing"] = "FAILED: Processing unsuccessful or zero quality"
        except Exception as e:
        ...
        try:
            ...
            understanding_quality = response.understanding.get("quality", 0.0) if response.understanding else 0.0
            ...
            if has_understanding:
                ...
                print(f"   Understanding Type: {response.understanding.get('type', 'N/A')}")
            
            if response.success and has_understanding:
                passed_tests += 1
                test_results["understanding_integration"] = "PASSED"
            else:
                test_results["understanding_integration"] = "FAILED: No understanding analysis"
        except Exception as e:
        ...
        try:
            ...
            consciousness_prob = response.consciousness.get("probability", 0.0) if response.consciousness else 0.0
            ...
            if has_consciousness:
                ...
                print(f"   Consciousness State: {response.consciousness.get('state', 'N/A')}")
                print(f"   Signature Strength: {response.consciousness.get('strength', 0.0):.3f}")
            
            if response.success and has_consciousness:
                passed_tests += 1
                test_results["consciousness_integration"] = "PASSED"
            else:
                test_results["consciousness_integration"] = "FAILED: No consciousness analysis"
        except Exception as e:
        ...
        try:
            ...
            print(f"   Average Processing Time: {final_status['performance']['average_processing_time']:.3f}s")
            print(f"   Component Health: {len(final_status['health']['component_health'])} components")
            
            if (final_status['performance']['total_operations'] > 0 and
                final_status['performance']['success_rate'] > 0.5):
                passed_tests += 1
                test_results["system_metrics"] = "PASSED"
            else:
                test_results["system_metrics"] = "FAILED: Insufficient operations or low success rate"
        except Exception as e:
