...
async def test_basic_imports():
    ...
    try:
        ...
        try:
            from src.core.communication_layer.meta_commentary_integration import MetaCommentaryIntegration
            from src.core.thermodynamic_systems.thermodynamic_integration_core import ThermodynamicIntegrationCore
            from src.core.advanced_processing.cognitive_field_integration import CognitiveFieldIntegration
...
async def test_individual_integrations():
    ...
    try:
        ...
        print(f"💬 Communication integration: {'✅ PASSED' if test_result else '❌ FAILED'}")
    except Exception as e:
    ...
    try:
        ...
        print(f"🌡️ Thermodynamic integration: {'✅ PASSED' if test_result else '❌ FAILED'}")
    except Exception as e:
    ...
    try:
        ...
        print(f"⚡ Advanced processing integration: {'✅ PASSED' if test_result else '❌ FAILED'}")
    except Exception as e:
