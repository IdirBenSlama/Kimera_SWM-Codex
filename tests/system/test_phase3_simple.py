...
async def test_understanding_core():
    ...
    try:
        ...
        result = await understanding_core.understand(
            "This is a test of understanding.", UnderstandingType.SEMANTIC
        )

        print(
            f"✅ Understanding Core: success={result.success}, depth={result.understanding_depth:.3f}"
        )
        return True
...
async def test_consciousness_core():
    ...
    try:
        ...
        print(
            f"✅ Consciousness Core: success={signature.success}, probability={signature.consciousness_probability:.3f}"
        )
        return True
    except Exception as e:
...
async def test_meta_insight_core():
    ...
    try:
        ...
        print(
            f"✅ Meta Insight Core: success={result.success}, strength={result.insight_strength:.3f}"
        )
        return True
    except Exception as e:
