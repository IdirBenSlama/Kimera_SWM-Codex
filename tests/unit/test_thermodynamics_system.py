...
from src.engines.insight_entropy import (
    MIN_ENTROPY_REDUCTION_THRESHOLD,
    is_insight_valid,
)
...
class TestThermodynamicsSystem(unittest.TestCase):
    ...
    def test_insight_validation_sufficient_entropy_reduction(self):
        ...
        self.assertTrue(
            is_insight_valid(valid_insight),
    ...
    def test_insight_validation_insufficient_entropy_reduction(self):
        ...
        self.assertFalse(
            is_insight_valid(invalid_insight),
    ...
    def test_insight_validation_at_threshold(self):
        ...
        self.assertTrue(
            is_insight_valid(threshold_insight),
    ...
    def test_transformation_with_entropy_increase(self):
        ...
        geoid_before = GeoidState(
            geoid_id="g1", semantic_state={"a": 0.5, "b": 0.5}
        )  # H=1.0
        geoid_after = GeoidState(
            geoid_id="g1", semantic_state={"a": 0.25, "b": 0.25, "c": 0.5}
        )  # H=1.5
