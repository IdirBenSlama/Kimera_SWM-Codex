...
async def quick_paper_test():
    ...
    # Create trader
    trader = create_safe_trader(
        "9268de76-b5f4-4683-b593-327fb2c19503", private_key=None, testnet=True
    )
    ...
    for symbol in ["BTC", "ETH", "SOL"]:
        ...
        if signal:
            print(
                f"✅ {symbol}: {signal.side} | Confidence: {signal.confidence:.2f} | R/R: {signal.risk_reward_ratio:.2f}"
            )
        else:
