...
class TestJobPriority(unittest.TestCase):
    ...
    def test_priority_values(self):
        ...
        priorities = [JobPriority.CRITICAL, JobPriority.HIGH, 
                     JobPriority.NORMAL, JobPriority.LOW, JobPriority.MAINTENANCE]
...
class TestBackgroundJobManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.manager = BackgroundJobManager(use_async=False)  # Use sync for easier testing
...
class TestKimeraJobs(unittest.TestCase):
    ...
    def test_crystallization_job(self, mock_session):
        ...
        mock_db.query.return_value.filter.return_value.all.return_value = [mock_scar]
        mock_db.query.return_value.filter.return_value.first.return_value = None  # Not already crystallized
