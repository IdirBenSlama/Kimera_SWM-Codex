...
class TestCLIPServiceIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher_model = patch('src.core.services.clip_service_integration.CLIPModel')
        self.patcher_processor = patch('src.core.services.clip_service_integration.CLIPProcessor')
