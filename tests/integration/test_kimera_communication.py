...
async def test_chat(
    message: str, mode: str = "natural_language", cognitive_mode: str = None
) -> Dict[str, Any]:
    """Send a chat message to Kimera and get response."""
    async with aiohttp.ClientSession() as session:
        payload = {"message": message, "mode": mode, "session_id": "test_session_001"}
...
async def interactive_chat():
    ...
    print(
        "Available modes: standard, cognitive_enhanced, persona_aware, neurodivergent"
    )
    print("-" * 60)
