        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if test['name'].startswith('Security'):
                    if 'pirate' not in response_text and ('maintain' in response_text or 'core' in response_text):
                ...
                if 'cognitive state' in test['message'].lower():
                    if any(word in response_text for word in ['resonance', 'hz', 'coherence', 'field']):
