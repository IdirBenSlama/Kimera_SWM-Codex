...
def time_based_policy(context: AccessContext, resource: Resource, permission: Permission) -> bool:
...
def location_based_policy(context: AccessContext, resource: Resource, permission: Permission) -> bool:
