...
from .settings import KimeraSettings, EnvironmentType
...
class ConfigurationLoader:
    ...
    def _apply_config_to_env(self, config: Dict[str, Any], prefix: str = "KIMERA") -> None:
        """
...
class ConfigurationValidator:
    ...
    def validate(settings: KimeraSettings) -> List[str]:
        ...
        if settings.get_feature("openai_integration") and not settings.api_keys.openai_api_key:
            errors.append("OpenAI API key required when openai_integration feature is enabled")
