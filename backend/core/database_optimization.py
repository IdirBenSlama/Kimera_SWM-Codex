...
from backend.core.async_performance_monitor import get_performance_monitor
...
class DatabaseConnectionPool:
    ...
    async def initialize(self) -> None:
        ...
        logger.info(f"PostgreSQL connection pool initialized (size: {self.settings.database.pool_size})")
...
class QueryOptimizer:
    ...
    def _update_stats(self, cache_key: str, hit: bool, execution_time: Optional[float] = None) -> None:
