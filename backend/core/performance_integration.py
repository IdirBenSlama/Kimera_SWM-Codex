...
from backend.config import get_settings, get_feature_flag
...
from .database_optimization import (
    DatabaseOptimizationMiddleware, get_db_optimization, cached_query, batch_query
)
from .cache_layer import CacheManager, get_cache_manager
from .startup_progress import (
    StartupProgressTracker, get_progress_tracker, track_startup_step, ProgressStage
)
from backend.monitoring.system_health_monitor import SystemHealthMonitor
from backend.layer_2_governance.monitoring.kimera_monitoring_core import KimeraMonitoringCore, get_monitoring_core
...
class PerformanceManager:
    ...
    async def initialize_system(self) -> Dict[str, Any]:
        ...
        async with track_startup_step("system_initialization", ProgressStage.INITIALIZING):
    ...
    def _register_core_components(self):
        ...
        # Monitoring Core
        @initialization_component("monitoring_core", dependencies=["config"], optional=False)
        ...
        @initialization_component("health_monitor", dependencies=["config", "monitoring_core"], optional=True)
        ...
        @initialization_component("embedding_model", dependencies=["cache"], optional=False)
        ...
        @initialization_component("contradiction_engine", dependencies=["embedding_model"])
