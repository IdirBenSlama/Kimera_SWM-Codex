...
any module—inside or outside FastAPI request-handling contexts.
...
from backend.core.ethical_governor import EthicalGovernor, ActionProposal, Verdict
from backend.utils.kimera_exceptions import KimeraCognitiveError, ErrorSeverity
