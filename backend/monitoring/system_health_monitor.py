...
class SystemHealthMonitor:
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        cpu_health = "healthy" if metrics["cpu"]["percent"] < 80 else "warning" if metrics["cpu"]["percent"] < 90 else "critical"
        memory_health = "healthy" if metrics["memory"]["percent"] < 80 else "warning" if metrics["memory"]["percent"] < 90 else "critical"
        disk_health = "healthy" if metrics["disk"]["percent"] < 80 else "warning" if metrics["disk"]["percent"] < 90 else "critical"
