...
from backend.config import get_settings, is_production, is_development
...
class CustomJsonFormatter(jsonlogger.JsonFormatter):
    ...
    def add_fields(self, log_record: Dict[str, Any], record: logging.LogRecord, message_dict: Dict[str, Any]):
        ...
        if record.exc_info:
            ...
            log_record["exc_text"] = logging.Formatter.formatException(self, record.exc_info)
...
class LoggingManager:
    ...
    def configure_logging(self):
        ...
        logging.info(f"Logging configured (level: {self.log_level}, structured: {self.settings.logging.structured})")
