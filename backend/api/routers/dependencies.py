...
def get_kimera_system():
    ...
    if _kimera_system is None:
        try:
            from backend.core.kimera_system import get_kimera_system as _get_system
...
def get_contradiction_engine():
    ...
    if _contradiction_engine is None:
        try:
            ...
            raise HTTPException(status_code=500, detail="ContradictionEngine not available")
...
def get_governance_engine():
    ...
    if _governance_engine is None:
        try:
            from backend.governance import GovernanceEngine, create_default_policies
            ...
            raise HTTPException(status_code=500, detail="GovernanceEngine not available")
