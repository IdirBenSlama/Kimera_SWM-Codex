...
def main():
    ...
    logger.info(f"   Counter-examples found: {report['mathematical_proof']['counter_examples_found']}")
    ...
    logger.info(f"   Mathematical Consistency: {report['conclusion']['mathematical_consistency']}")
    logger.info(f"   Empirical Support: {report['conclusion']['empirical_support']:.1%}")
