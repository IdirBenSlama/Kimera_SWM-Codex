...
from backend.trading.live_trading_config import LiveTradingConfig, KimeraLiveTradingManager
from backend.trading.autonomous_kimera_trader import CognitiveSignal, AutonomousPosition
...
def create_live_execution_bridge(
    ...
    from backend.trading.live_trading_config import create_live_trading_config
