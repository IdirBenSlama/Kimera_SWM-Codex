...
try:
    from backend.trading.intelligence.market_intelligence import IntelligenceOrchestrator
    from backend.trading.intelligence.sentiment_analyzer import AdvancedSentimentAnalyzer, CryptoSpecificSentiment
    from backend.trading.intelligence.live_data_collector import LiveDataCollector, SimulatedDataCollector
