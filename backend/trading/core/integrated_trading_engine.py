...
try:
    from backend.kimera.cognitive_field_dynamics import CognitiveFieldDynamics
    from backend.kimera.contradiction_detection import ContradictionEngine
    from backend.kimera.semantic_thermodynamics import SemanticThermodynamicsEngine
...
try:
    from backend.trading.intelligence.enhanced_anomaly_detector import EnhancedAnomalyDetector, AnomalyType, create_enhanced_detector
    from backend.trading.optimization.portfolio_optimizer import AdvancedPortfolioOptimizer, OptimizationObjective, create_portfolio_optimizer
...
if __name__ == "__main__":
    ...
    logger.info("🚀 Testing Integrated Kimera Trading Engine")
    logger.info("=" * 50)
    ...
    logger.info("\n✅ Integrated Kimera Engine Test Complete!")