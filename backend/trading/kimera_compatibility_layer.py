...
from backend.utils.kimera_logger import get_cognitive_logger
...
def create_compatibility_wrappers(kimera_system):
    ...
    try:
        ...
        if thermodynamics_engine:
            ...
            logger.info("✓ Thermodynamics engine wrapper created")
        else:
            logger.warning("✗ Thermodynamics engine not available")
        ...
        if contradiction_engine:
            ...
            logger.info("✓ Contradiction engine wrapper created")
        else:
        ...
        try:
            ...
            logger.info("✓ Cognitive field dynamics wrapper created")
        except Exception as e:
            wrappers['cognitive_field'] = CognitiveFieldDynamicsWrapper(None)
            logger.info("✓ Cognitive field dynamics fallback wrapper created")
