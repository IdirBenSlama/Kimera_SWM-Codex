...
os.environ['DATABASE_URL'] = os.environ.get('DATABASE_URL', 'postgresql+psycopg2://kimera:kimera_secure_pass_2025@localhost:5432/kimera_swm')
os.environ['KIMERA_DATABASE_URL'] = os.environ.get('KIMERA_DATABASE_URL', 'postgresql+psycopg2://kimera:kimera_secure_pass_2025@localhost:5432/kimera_swm')

# Additional PostgreSQL environment variables for completeness
os.environ['POSTGRES_USER'] = os.environ.get('POSTGRES_USER', 'kimera')
os.environ['POSTGRES_PASSWORD'] = os.environ.get('POSTGRES_PASSWORD', 'kimera_secure_pass_2025')
