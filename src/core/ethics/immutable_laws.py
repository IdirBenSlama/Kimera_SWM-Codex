...
class ImmutableLawRegistry:
    ...
    def _initialize_core_laws(self):
        ...
        self._add_law(
            "N1",
            LawCategory.NEUTRALITY
            "Bias Injection Prohibition",
...
_global_registry: Optional[ImmutableLawRegistry] = None
_registry_lock = threading.Lock()


def get_law_registry() -> ImmutableLawRegistry:
    """
    Provides a thread-safe singleton instance of the ImmutableLawRegistry.
...
def verify_law_integrity() -> bool:
    """Convenience function to verify integrity of the global registry"""
