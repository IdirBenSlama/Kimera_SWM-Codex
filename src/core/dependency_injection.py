...
class ServiceContainer:
    ...
    def register_singleton(self, interface: Type[T], implementation: Type[T]) -> 'ServiceContainer':
        ...
        return self.register(interface, implementation=implementation, lifetime=ServiceLifetime.SINGLETON)
    
    def register_transient(self, interface: Type[T], implementation: Type[T]) -> 'ServiceContainer':
        """Register a transient service"""
        return self.register(interface, implementation=implementation, lifetime=ServiceLifetime.TRANSIENT)
    
    def register_scoped(self, interface: Type[T], implementation: Type[T]) -> 'ServiceContainer':
        """Register a scoped service"""
        return self.register(interface, implementation=implementation, lifetime=ServiceLifetime.SCOPED)
    
    def register_factory(self, interface: Type[T], factory: Callable[[], T], lifetime: str = ServiceLifetime.SINGLETON) -> 'ServiceContainer':
    ...
    def resolve(self, interface: Type[T]) -> T:
        ...
        with self._lock:
            ...
            if descriptor.lifetime == ServiceLifetime.SINGLETON:
                ...
                raise RuntimeError("Scoped services must be resolved within a scope. Use create_scope().")
    ...
    def _create_instance(self, descriptor: ServiceDescriptor) -> Any:
        ...
        if descriptor.interface in self._building:
            raise RuntimeError(f"Circular dependency detected for {descriptor.interface.__name__}")
