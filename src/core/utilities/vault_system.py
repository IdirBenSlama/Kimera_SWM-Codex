...
class VaultSystem:
    ...
    def retrieve_geoid(self, geoid_id: str) -> Optional[GeoidState]:
        ...
        try:
            ...
            if geoid:
                ...
                logger.debug(f"Retrieved geoid {geoid_id[:8]} from storage in {duration:.3f}s")
    ...
    def retrieve_scar(self, scar_id: str) -> Optional[ScarState]:
        ...
        try:
            ...
            if scar:
                ...
                logger.debug(f"Retrieved SCAR {scar_id[:8]} from storage in {duration:.3f}s")
    ...
    def cleanup_old_data(self, retention_days: Optional[int] = None) -> int:
        ...
        try:
            ...
            logger.info(f"Cleaned up {removed_count} old items (retention: {retention} days)")
            return removed_count
