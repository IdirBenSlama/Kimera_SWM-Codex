    ...
    def is_torch_safe() -> Tuple[bool, str]:
        ...
        try:
            ...
            if major > 2 or (major == 2 and minor >= 6):
                ...
                logger.warning(f"PyTorch {torch.__version__} has CVE-2025-32434 vulnerability")
...
class ResourceMonitor:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        """Get current metrics"""
        with self._lock:
            cache_rate = (self.cache_hits / self.total_embeddings * 100) if self.total_embeddings > 0 else 0
            avg_time = (self.total_processing_time / self.total_embeddings) if self.total_embeddings > 0 else 0
...
def get_clip_service(model_name: str = "openai/clip-vit-base-patch32",
                    use_cache: bool = True) -> CLIPServiceIntegration:
