...
class ConfigurationManager:
    ...
    def _configure_logging(self, settings: KimeraSettings) -> None:
        ...
        log_config = {
            ...
            "formatters": {
                "default": {"format": settings.logging.format},
                "structured": {
                    "()": (
            ...
            "handlers": {
                "console": {
                    ...
                    "formatter": (
                        "structured" if settings.logging.structured else "default"
                    ),
                    "stream": "ext://sys.stdout",
                }
            },
            "root": {"level": settings.logging.level.value, "handlers": ["console"]},
        }
    ...
    def register_callback(
        self, name: str, callback: Callable[[KimeraSettings], None]
    ) -> None:
        """
