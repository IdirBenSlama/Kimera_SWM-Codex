...
def calculate_predictability_index(
    data: List[Union[float, int]], m: int, r: float
) -> float:
    """
...
def _patterns_match(
    pattern1: np.ndarray, pattern2: np.ndarray, tolerance: float
) -> bool:
    """
...
def calculate_sample_entropy(
    data: List[Union[float, int]], m: int = 2, r: float = None
) -> float:
    """
...
def calculate_permutation_entropy(
    data: List[Union[float, int]], order: int = 3, delay: int = 1
) -> float:
    """
    ...
    probabilities = [
        count / total_patterns for count in perm_counts.values() if count > 0
    ]
...
def calculate_multiscale_entropy(
    data: List[Union[float, int]], max_scale: int = 10, m: int = 2, r: float = None
) -> List[float]:
    """
...
def calculate_enhanced_predictability_index(
    ...
    for i, scale in enumerate(scales):
        ...
        approx_ent = calculate_approximate_entropy(
            data, scale, tolerance_factor * std_data
        )
