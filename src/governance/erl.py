...
class EthicalReflexLayer:
    ...
    def validate_detailed(self, content: Any) -> EthicalValidationResult:
        ...
        for bias_type, indicators in self.bias_indicators.items():
            for indicator in indicators:
                if indicator in content_lower:
                    ...
                    reasoning_parts.append(f"Contains potential {bias_type} bias: '{indicator}'")
        ...
        return EthicalValidationResult(
            ...
            reasoning="; ".join(reasoning_parts) if reasoning_parts else "No ethical concerns detected"
        )
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'violation_rate': self.violation_count / self.validation_count if self.validation_count > 0 else 0
        }
