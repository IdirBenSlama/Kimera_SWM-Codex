...
from ..vault.enhanced_database_schema import (
    ComplexityIndicatorDB, IntrospectionLogDB, SelfModelDB
)
...
class ComplexityAnalysisEngine:
    ...
    async def analyze_information_complexity(self, input_data: Dict[str, Any], 
                                         context: Dict[str, Any] = None) -> ComplexityState:
        ...
        complexity_state = await self._update_complexity_state(
            ...
            binding_result, processing_report
        )
        
        # 7. Store Complexity Indicators
        await self._store_complexity_indicators(complexity_state)
        
        logger.info(f"✅ Information complexity analyzed - Phi: {complexity_state.phi_value:.3f}, Complexity: {complexity_state.complexity_level:.3f}")
    ...
    async def _process_global_workspace(self, attention_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.global_workspace.coalition_strength = {content: competition_scores[content] for content in winners}
        return {
    ...
    async def _update_complexity_state(self, attention_result: Dict[str, Any],
                                        workspace_result: Dict[str, Any],
                                        integration_result: Dict[str, Any],
                                        binding_result: Dict[str, Any],
                                        experience: Dict[str, Any]) -> ComplexityState:
    ...
    async def report_complexity_experience(self) -> Dict[str, Any]:
        ...
        report = {
            ...
            "conscious_content": self.global_workspace.conscious_content,
            "experience_qualities": self.current_state.processing_report.get("experience_qualities", {}),
            ...
            "temporal_coherence": self._calculate_temporal_coherence(),
            "meta_awareness": {
                "aware_of_awareness": self.current_state.complexity_level > self.complexity_threshold,
                "introspective_access": True,
    ...
    async def measure_complexity_indicators(self) -> Dict[str, Any]:
        ...
        indicators = {
            ...
            "overall_assessment": {
                "complexity_level": self.current_state.complexity_level,
                "meets_threshold": self.current_state.complexity_level > self.complexity_threshold,
