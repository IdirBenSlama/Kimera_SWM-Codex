    ...
    def analyze_engine_compliance(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            analysis = {
                ...
                'has_config_import': 'from ..utils.config import get_api_settings' in content or 'from backend.utils.config import get_api_settings' in content,
                'has_settings_import': 'from ..config.settings import get_settings' in content or 'from backend.config.settings import get_settings' in content,
