...
from backend.config import get_settings, initialize_configuration
from backend.main import app
from backend.core.performance_integration import get_performance_manager
from backend.layer_2_governance.monitoring.monitoring_integration import get_monitoring_manager
from backend.security.security_integration import get_security_manager
...
async def validate_security():
    ...
    try:
        ...
        from backend.security.authentication import auth_manager
