...
def test_hardware_config():
    ...
    try:
        from backend.config import hardware_config
        ...
        print(f"Adaptive Batch Size Range: {hardware_config.ADAPTIVE_BATCH_SIZE_MIN} - {hardware_config.ADAPTIVE_BATCH_SIZE_MAX}")
...
def test_gpu_memory_pool():
    ...
    try:
        from backend.engines.gpu_memory_pool import GPUMemoryPool
