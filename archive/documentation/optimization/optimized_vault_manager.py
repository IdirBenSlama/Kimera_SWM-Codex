...
class OptimizedVaultManager:
    ...
    def _update_stats_cache(self):
        ...
        try:
            ...
            logger.error(f"Warning: Failed to update stats cache: {e}")
    ...
    def _flush_batch(self):
        ...
        try:
            ...
            logger.error(f"Warning: Batch flush failed: {e}")
            self._batch_buffer.clear()
    ...
    def rebalance_vaults_optimized(self, *, by_weight: bool = False, 
        ...
        try:
            ...
            logger.error(f"Error during vault rebalancing: {e}")
            return 0
                ...
                for vault_id in ["vault_a", "vault_b"]:
                    ...
                    if current_count > max_scars_per_vault:
                        ...
                        if old_scar_ids:
                            ...
                            logger.info(f"Cleaned up {len(old_scar_ids)
                
                db.commit()
                
        except Exception as e:
            logger.error(f"Error during scar cleanup: {e}")
