...
app.include_router(unified_thermodynamic_router, prefix="/kimera", tags=["Unified Thermodynamic + TCSE"])
app.include_router(gpu_router, prefix="/kimera", tags=["GPU Acceleration"])
app.include_router(linguistic_router, prefix="/kimera", tags=["Linguistic Intelligence"])
app.include_router(cognitive_architecture_router, prefix="/kimera", tags=["Cognitive Architecture"])
