...
if __name__ == "__main__":
    ...
    logger.info(json.dumps(manager.get_status(), indent=2))
    logger.info()
    logger.info("⚠️  To enable live trading, you must:")
    logger.info("   1. Set your actual API credentials")
    logger.info("   2. Ensure you have the private key file")
    logger.info("   3. Understand the risks involved")
    logger.info("   4. Monitor the system actively")
    logger.info("   5. Have emergency stop procedures ready") 