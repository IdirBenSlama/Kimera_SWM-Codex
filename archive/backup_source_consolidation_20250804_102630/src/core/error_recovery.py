...
class ErrorRecoveryManager:
    ...
    def __init__(self):
        ...
        self.recovery_actions: Dict[ErrorCategory, List[RecoveryAction]] = self._init_recovery_actions()
            ...
            try:
                if action.handler:
                    ...
                    if result is not None:
                        ...
                        logger.info(f"✅ Recovery successful using {action.action_type}")
                        return result
                else:
    ...
    def _log_error(self, context: ErrorContext):
        ...
        message = (f"Error in {context.component}.{context.operation}: "
    ...
    def get_error_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_recovery_rate": total_recoveries / total_errors if total_errors > 0 else 0,
