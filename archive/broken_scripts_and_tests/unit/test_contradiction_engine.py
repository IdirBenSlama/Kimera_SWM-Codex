...
class TestContradictionEngine(unittest.TestCase):
    ...
    def test_ignores_weak_contradiction(self):
        ...
        logger.info("[SUCCESS] Engine correctly ignored the weak contradiction.")
