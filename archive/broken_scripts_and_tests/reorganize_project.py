...
class ProjectReorganizer:
        ...
        for item in files_to_move:
            try:
                ...
                if new_location:
                    ...
                    moved_count += 1
                    logger.info(f"Moved: {item.name} -> {new_location}")
    ...
    def create_new_structure_files(self):
        ...
        logger.info("Creating new structure files...")
...
"""
        ...
        logger.info("New structure files created.")
    ...
    def generate_report(self):
        ...
        logger.info("Reorganization complete! Report saved to REORGANIZATION_REPORT.json")
...
def main():
    ...
    logger.info("KIMERA SWM Project Reorganization")
    logger.info("=" * 40)
    ...
    try:
        ...
        logger.info("📁 Backup created at: backup_before_reorganization/")
        logger.info("📊 See REORGANIZATION_REPORT.json for details")
        logger.info("\nNext steps:")
        logger.info("1. Review the new structure")
        logger.info("2. Update import statements in code")
        logger.info("3. Update CI/CD configurations")
        logger.info("4. Test the reorganized system")
        
    except Exception as e:
        logger.error(f"\n❌ Error during reorganization: {e}")
        logger.info("The backup is available at: backup_before_reorganization/")
