...
async def example_usage():
    ...
    async def on_decoherence(claim_id: str, measurement: QuantumMeasurement):
        print(f"🌊 Decoherence: {claim_id} disturbed by {measurement.measurement_disturbance:.3f}")
    ...
    print(f"   Decoherence Events: {status['decoherence_events']}")
    print(f"   Average Confidence: {status['average_epistemic_confidence']:.3f}")
