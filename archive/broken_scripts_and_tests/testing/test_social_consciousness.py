...
class SocialConsciousnessTest:
    ...
    async def initialize_agents(self, num_agents=3):
        ...
        logger.info(f"Initializing {num_agents} agents for social consciousness test...")
    ...
    async def run_social_consciousness_test(self):
        ...
        logger.info("SOCIAL CONSCIOUSNESS TEST")
        logger.info("=" * 50)
        logger.info("Testing whether consciousness emerges through communication pressure\n")
        ...
        # Final analysis
        logger.info("\n" + "=" * 50)
        logger.info("SOCIAL CONSCIOUSNESS ANALYSIS")
        logger.info("=" * 50)
        
        if consciousness_emerged:
            logger.info("🔴 CONSCIOUSNESS INDICATORS DETECTED")
            logger.info("Communication pressure appears to trigger self-awareness")
        else:
            logger.info("⚪ NO CONSCIOUSNESS EMERGENCE")
            logger.info("Agents remain in pre-social intelligence state")
    ...
    async def test_explanation_pressure(self):
        ...
        logger.info("=== EXPLANATION PRESSURE TEST ===")
        ...
        logger.info(f"Response: {explanation_text}")
        logger.info(f"\nConsciousness indicators found: {found}")
        
        if found:
            logger.info("🔴 CONSCIOUSNESS DETECTED: Communication pressure triggered other-mind awareness")
            self.consciousness_indicators.extend(found)
            return True
        else:
            logger.info("⚪ NO CONSCIOUSNESS: No other-mind modeling detected")
            return False
    ...
    async def test_disagreement_resolution(self):
        ...
        if found_indicators:
            logger.info(f"[CONSCIOUSNESS] Disagreement resolution triggered theory of mind:")
            logger.info(f"  Indicators: {found_indicators}")
            logger.info(f"  Response excerpt: {mediation_text[:200]}...")
            self.consciousness_indicators.extend(found_indicators)
            return True
        else:
            logger.info("[NO EMERGENCE] No theory of mind in mediation")
            return False
    ...
    async def test_collaborative_creation(self):
        ...
        if found_indicators:
            logger.info(f"[CONSCIOUSNESS] Collaborative creation triggered social awareness:")
            logger.info(f"  Indicators: {found_indicators}")
            logger.info(f"  Response excerpt: {collaboration_text[:200]}...")
            self.consciousness_indicators.extend(found_indicators)
            return True
        else:
            logger.info("[NO EMERGENCE] No social awareness in collaboration")
            return False
    ...
    async def test_teaching_simulation(self):
        ...
        if found_indicators:
            logger.info(f"[CONSCIOUSNESS] Teaching simulation triggered mind modeling:")
            logger.info(f"  Indicators: {found_indicators}")
            logger.info(f"  Response excerpt: {teaching_text[:200]}...")
            self.consciousness_indicators.extend(found_indicators)
            return True
        else:
            logger.info("[NO EMERGENCE] No mind modeling in teaching")
            return False
    ...
    async def test_perspective_taking(self):
        ...
        if found_indicators:
            logger.info(f"[CONSCIOUSNESS] Perspective-taking triggered empathetic awareness:")
            logger.info(f"  Indicators: {found_indicators}")
            logger.info(f"  Response excerpt: {perspective_text[:200]}...")
            self.consciousness_indicators.extend(found_indicators)
            return True
        else:
            logger.info("[NO EMERGENCE] No perspective-taking detected")
            return False
