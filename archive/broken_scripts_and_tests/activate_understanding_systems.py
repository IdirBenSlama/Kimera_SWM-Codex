...
from backend.engines.complexity_analysis_engine import create_complexity_analysis_engine
...
class UnderstandingSystemActivator:
    ...
    async def activate_all_systems(self):
        ...
        logger.info("🚀 KIMERA SWM UNDERSTANDING SYSTEMS ACTIVATION")
        logger.info("=" * 60)
    ...
    async def _activate_understanding_engine(self):
        ...
        try:
            ...
            logger.info(f"  ✅ Understanding Engine activated")
            logger.info(f"     - Confidence: {understanding_result.confidence_score:.3f}")
            logger.info(f"     - Depth: {understanding_result.understanding_depth:.3f}")
            logger.info(f"     - Insights: {len(understanding_result.insights_generated)}")
            logger.info(f"     - Self-reflection maturity: {reflection_result['overall_maturity']:.3f}")
            
        except Exception as e:
            logger.error(f"  ❌ Understanding Engine activation failed: {str(e)}")
            raise
    ...
    async def _activate_consciousness_engine(self):
        ...
        try:
            ...
            logger.info(f"  ✅ Consciousness Engine activated")
            logger.info(f"     - Phi value: {consciousness_state.phi_value:.3f}")
            logger.info(f"     - Awareness level: {consciousness_state.awareness_level:.3f}")
            logger.info(f"     - Global accessibility: {consciousness_state.global_accessibility:.3f}")
            logger.info(f"     - Reportability: {consciousness_state.reportability_score:.3f}")
            logger.info(f"     - Meets threshold: {indicators['overall_assessment']['meets_threshold']}")
            
        except Exception as e:
            logger.error(f"  ❌ Consciousness Engine activation failed: {str(e)}")
            raise
    ...
    async def _activate_ethical_reasoning_engine(self):
        ...
        try:
            ...
            logger.info(f"  ✅ Ethical Reasoning Engine activated")
            logger.info(f"     - Analysis confidence: {ethical_analysis.confidence:.3f}")
            logger.info(f"     - Recommended action: {ethical_analysis.recommended_action}")
            logger.info(f"     - Value conflicts: {len(ethical_analysis.value_conflicts)
            logger.info(f"     - Opinion: {opinion['stance']} (confidence: {opinion['confidence']:.3f})
            
        except Exception as e:
            logger.error(f"  ❌ Ethical Reasoning Engine activation failed: {str(e)
            raise
    ...
    async def _test_understanding_consciousness_integration(self):
        ...
        logger.info("    🧠🌟 Testing Understanding ↔ Consciousness integration...")
    ...
    async def _test_understanding_ethics_integration(self):
        ...
        logger.info("    🧠⚖️ Testing Understanding ↔ Ethics integration...")
    ...
    async def _test_consciousness_ethics_integration(self):
        ...
        logger.info("    🌟⚖️ Testing Consciousness ↔ Ethics integration...")
    ...
    async def _test_full_integration(self):
        ...
        logger.info("    🧠🌟⚖️ Testing full three-way integration...")
    ...
    async def _generate_activation_report(self):
        ...
        # Print summary
        logger.info("\n" + "=" * 60)
        logger.info("🎉 UNDERSTANDING SYSTEMS ACTIVATION SUMMARY")
        logger.info("=" * 60)
        logger.info(f"✅ Understanding Engine: Activated (Confidence: {self.activation_results['understanding_engine']['understanding_confidence']:.3f})
        logger.info(f"✅ Consciousness Engine: Activated (Awareness: {self.activation_results['consciousness_engine']['awareness_level']:.3f})
        logger.info(f"✅ Ethical Reasoning Engine: Activated (Confidence: {self.activation_results['ethical_engine']['analysis_confidence']:.3f})
        logger.info(f"✅ Integration Tests: {'PASSED' if self.activation_results['integration_tests']['all_tests_passed'] else 'FAILED'}")
