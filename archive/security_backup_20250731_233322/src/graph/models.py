...
The philosophy is:
    â€¢ keep functions small & explicit (e.g. `create_geoid`, `get_geoid`)
    â€¢ pass/return **plain dicts** so callers are decoupled from the driver
    â€¢ embed Cypher in triple-quoted strings for readability and ease of
      migration scripts.
