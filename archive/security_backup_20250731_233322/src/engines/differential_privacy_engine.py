...
class DifferentialPrivacyEngine:
    ...
    def __init__(self, config: Optional[CognitivePrivacyConfig] = None, device_id: int = 0):
        ...
        logger.info(f"Global privacy: Îµ={self.config.global_epsilon}, Î´={self.config.global_delta}")
    
    def _initialize_rdp_accountant(self) -> Dict[float, float]:
        """Initialize RÃ©nyi Differential Privacy accountant"""
    ...
    def get_privacy_spent(self) -> Dict[str, float]:
        ...
        # Convert RDP to (Îµ,Î´) if using RDP
    ...
    def _compute_rdp_privacy(self, target_delta: Optional[float] = None) -> Tuple[float, float]:
        """Convert RDP guarantees to (Îµ,Î´)-DP
        
        Args:
            target_delta: Target Î´ value
        ...
        # Find minimum Îµ over all orders
