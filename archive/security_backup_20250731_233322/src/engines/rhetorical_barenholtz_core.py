...
self.ethos_indicators = self._initialize_ethos_patterns()
    ...
    def _initialize_ethos_patterns(self) -> Dict[str, List[str]]:
        ...
        return {
            "authority_claims": [
                r"as an expert", r"in my \d+ years", r"according to research",
                r"studies show", r"evidence indicates", r"my experience",
                r"as a professional", r"certified", r"peer-reviewed"
            ],
            "credibility_markers": [
                r"honestly", r"frankly", r"to be clear", r"in truth",
                r"let me be direct", r"speaking candidly", r"without bias"
            ],
            "institutional_backing": [
                r"university", r"institute", r"organization", r"government",
                r"official", r"licensed", r"accredited", r"endorsed"
            ],
            "personal_stake": [
                r"as someone who", r"having experienced", r"personally",
                r"from my perspective", r"in my situation", r"as a parent/child/etc"
            ]
        }
    ...
    def _initialize_pathos_patterns(self) -> Dict[str, List[str]]:
        ...
        return {
            "emotional_language": [
                r"devastating", r"heartbreaking", r"inspiring", r"outrageous",
                r"shocking", r"beautiful", r"terrible", r"magnificent",
                r"tragic", r"joyful", r"horrifying", r"wonderful"
            ],
            "value_appeals": [
                r"freedom", r"justice", r"fairness", r"equality", r"security",
                r"family", r"children", r"future", r"tradition", r"progress"
            ],
            "fear_appeals": [
                r"danger", r"threat", r"risk", r"catastrophe", r"disaster",
                r"crisis", r"emergency", r"urgent", r"critical", r"alarming"
            ],
            "hope_appeals": [
                r"opportunity", r"potential", r"possibility", r"hope",
                r"dream", r"vision", r"future", r"better", r"improve"
            ],
            "identity_appeals": [
                r"we", r"us", r"our", r"together", r"community", r"shared",
                r"common", r"united", r"solidarity", r"belonging"
            ]
        }
    ...
    def _initialize_logos_patterns(self) -> Dict[str, List[str]]:
        ...
        return {
            "logical_connectors": [
                ...
                r"because", r"since", r"given that", r"due to", r"hence"
            ],
            "evidence_markers": [
                r"data shows", r"statistics indicate", r"research proves",
                r"studies demonstrate", r"evidence suggests", r"facts show"
            ],
            "reasoning_patterns": [
                r"if.*then", r"either.*or", r"not only.*but also",
                r"on one hand.*on the other", r"while.*nevertheless"
            ],
            "quantification": [
                r"\d+%", r"\d+ percent", r"majority", r"minority",
                r"significant", r"substantial", r"negligible", r"considerable"
            ],
            "logical_structure": [
                r"first", r"second", r"finally", r"in conclusion",
                r"to summarize", r"in other words", r"specifically"
            ]
        }
    ...
    def _initialize_rhetorical_devices(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "rhetorical_question": {
                "patterns": [r"\?.*\?", r"isn't it", r"don't you think", r"wouldn't you"],
    ...
    async def analyze_classical_rhetoric(self, text: str) -> Dict[str, Any]:
        ...
        rhetorical_balance = self._calculate_rhetorical_balance(ethos_score, pathos_score, logos_score)
        
        return {
            "ethos": {
                "score": ethos_score,
                "elements": ethos_elements
            },
            "pathos": {
                "score": pathos_score,
                "elements": pathos_elements
            },
            "logos": {
                "score": logos_score,
                "elements": logos_elements
            },
    ...
    def _calculate_ethos_score(self, text: str) -> float:
        ...
        base_score = found_indicators / max(total_indicators, 1) if total_indicators > 0 else 0
        
        # Adjust for text length and context
        length_factor = min(len(text.split()) / 100, 1.0)  # Longer texts can build more credibility
    ...
    def _calculate_rhetorical_balance(self, ethos: float, pathos: float, logos: float) -> Dict[str, Any]:
...
self.toulmin_patterns = self._initialize_toulmin_patterns()
    ...
    def _initialize_toulmin_patterns(self) -> Dict[str, List[str]]:
        ...
        return {
            "claim_markers": [
                r"I argue that", r"my claim is", r"I contend", r"I propose",
                r"the point is", r"essentially", r"in conclusion", r"therefore"
            ],
            "data_markers": [
                r"evidence shows", r"data indicates", r"research proves",
                r"studies demonstrate", r"statistics reveal", r"facts show",
                r"observations suggest", r"findings indicate"
            ],
            "warrant_markers": [
                r"because", r"since", r"given that", r"assuming",
                r"based on the principle", r"it follows that", r"naturally"
            ],
            "backing_markers": [
                r"this is supported by", r"further evidence", r"additional research",
                r"experts agree", r"consensus shows", r"established theory"
            ],
            "qualifier_markers": [
                r"probably", r"likely", r"presumably", r"generally",
                r"in most cases", r"typically", r"usually", r"often"
            ],
            "rebuttal_markers": [
                r"however", r"but", r"nevertheless", r"on the other hand",
                r"critics argue", r"some might say", r"alternatively"
            ]
        }
    ...
    def _initialize_fallacy_patterns(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "ad_hominem": {
                "patterns": [r"you are", r"people like you", r"typical", r"what do you know"],
            ...
            "false_dichotomy": {
                "patterns": [r"either.*or", r"only two", r"you must choose", r"no other option"],
                "description": "Presenting false binary choice",
                "severity": 0.6
            },
            "slippery_slope": {
                "patterns": [r"if we allow", r"next thing", r"leads to", r"where does it end"],
    ...
    async def analyze_modern_argumentation(self, text: str) -> Dict[str, Any]:
        ...
        argument_strength = self._calculate_argument_strength(toulmin_mapping, fallacies)
    ...
    def _calculate_toulmin_strength(self, claims: List[str], data: List[str], 
                                  warrant: str, backing: List[str]) -> float:
    ...
    def _analyze_discourse_structure(self, text: str) -> Dict[str, Any]:
        ...
        present_elements = sum(1 for key in ["introduction", "development", "contrast", "conclusion"] 
                              if structure[key])
        structure["organization_score"] = present_elements / 4
        
        return structure
    
    def _calculate_argument_strength(self, toulmin_mapping: ArgumentMapping, 
                                   fallacies: List[Dict[str, Any]]) -> float:
    ...
    def _assess_logical_coherence(self, text: str, discourse_structure: Dict[str, Any]) -> float:
        ...
        logical_connectors = [
            r"therefore", r"thus", r"consequently", r"as a result",
            r"because", r"since", r"given that", r"due to"
        ]
...
self.cultural_traditions = self._initialize_cultural_traditions()
    ...
    def _initialize_cultural_traditions(self) -> Dict[RhetoricalTradition, Dict[str, Any]]:
        """Initialize cross-cultural rhetorical traditions"""
        return {
            RhetoricalTradition.CLASSICAL_WESTERN: {
                "characteristics": ["logical_structure", "evidence_based", "individual_focus"],
            ...
            RhetoricalTradition.EASTERN_CONFUCIAN: {
                "characteristics": ["harmony_seeking", "relationship_focus", "indirect_approach"],
            ...
            RhetoricalTradition.EASTERN_BUDDHIST: {
                "characteristics": ["paradox_acceptance", "mindfulness", "compassion_centered"],
            ...
            RhetoricalTradition.ISLAMIC_RHETORIC: {
                "characteristics": ["textual_authority", "community_focus", "moral_grounding"],
            ...
            RhetoricalTradition.INDIGENOUS_ORAL: {
                "characteristics": ["storytelling", "experiential", "circular_structure"],
            ...
            RhetoricalTradition.FEMINIST_RHETORIC: {
                "characteristics": ["personal_political", "collaborative", "voice_giving"],
    ...
    def _initialize_persuasion_strategies(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "eastern_harmony": {
                "patterns": ["consensus-building", "face-saving", "indirect-suggestion"],
            ...
            "authority_based": {
                "patterns": ["expert-citation", "institutional-backing", "tradition-reference"],
                "effectiveness": {"western": 0.7, "eastern": 0.8, "indigenous": 0.6}
            }
        }
    
    async def analyze_cross_cultural_rhetoric(self, text: str, 
                                            target_culture: str = "western") -> Dict[str, Any]:
        ...
        effectiveness = self._assess_cross_cultural_effectiveness(text, detected_tradition, target_culture)
        
        # Identify cultural barriers
        barriers = self._identify_cultural_barriers(text, detected_tradition, target_culture)
        
        # Suggest adaptations
        adaptations = self._suggest_cultural_adaptations(text, detected_tradition, target_culture)
    ...
    def _detect_rhetorical_tradition(self, text: str) -> RhetoricalTradition:
        ...
        for tradition, characteristics in self.cultural_traditions.items():
            ...
            if "harmony_seeking" in characteristics["characteristics"]:
                if re.search(r"together|harmony|balance|consensus", text, re.IGNORECASE):
                    score += 1
            
            if "storytelling" in characteristics["characteristics"]:
                if re.search(r"once|story|imagine|let me tell you", text, re.IGNORECASE):
                    score += 1
            
            if "textual_authority" in characteristics["characteristics"]:
                if re.search(r"scripture|text|tradition|authority", text, re.IGNORECASE):
                    score += 1
    ...
    def _assess_cross_cultural_effectiveness(self, text: str, 
                                           tradition: RhetoricalTradition,
        ...
        if target_culture == "western" and tradition == RhetoricalTradition.CLASSICAL_WESTERN:
            base_effectiveness += 0.3
        elif target_culture == "eastern" and tradition in [RhetoricalTradition.EASTERN_CONFUCIAN, 
                                                          RhetoricalTradition.EASTERN_BUDDHIST]:
            base_effectiveness += 0.3
        ...
        barrier_penalty = self._calculate_barrier_penalty(text, tradition, target_culture)
        
        final_effectiveness = max(base_effectiveness - barrier_penalty, 0.0)
        
        return min(final_effectiveness, 1.0)
    
    def _identify_cultural_barriers(self, text: str, tradition: RhetoricalTradition,
                                  target_culture: str) -> List[str]:
        """Identify potential cultural barriers"""
        barriers = []
        
        # Direct vs. indirect communication
        if target_culture == "eastern" and re.search(r"directly|bluntly|frankly", text, re.IGNORECASE):
            barriers.append("Direct communication style may be perceived as rude")
        
        # Individual vs. collective focus
        if target_culture == "eastern" and re.search(r"\bi\b|\bme\b|\bmy\b", text, re.IGNORECASE):
            individual_count = len(re.findall(r"\bi\b|\bme\b|\bmy\b", text, re.IGNORECASE))
            collective_count = len(re.findall(r"\bwe\b|\bus\b|\bour\b", text, re.IGNORECASE))
            if individual_count > collective_count:
                barriers.append("Excessive individual focus may clash with collective values")
        
        # Authority and hierarchy
        if target_culture == "western" and re.search(r"tradition|authority|hierarchy", text, re.IGNORECASE):
            barriers.append("Authority-based arguments may be less effective in egalitarian contexts")
        
        return barriers
    
    def _suggest_cultural_adaptations(self, text: str, tradition: RhetoricalTradition,
                                    target_culture: str) -> List[str]:
    ...
    def _calculate_barrier_penalty(self, text: str, tradition: RhetoricalTradition,
                                 target_culture: str) -> float:
        """Calculate penalty for cultural barriers"""
        penalty = 0.0
        
        # Check for major cultural mismatches
        if target_culture == "eastern" and tradition == RhetoricalTradition.CLASSICAL_WESTERN:
            # Check for overly direct or individualistic language
            direct_markers = len(re.findall(r"directly|bluntly|frankly", text, re.IGNORECASE))
            individual_markers = len(re.findall(r"\bi\b|\bme\b|\bmy\b", text, re.IGNORECASE))
...
self.enhanced_processor = enhanced_processor
    ...
    async def process_rhetorical_dual_system(self, text: str, context: Dict[str, Any]) -> DualSystemResult:
        ...
        rhetorical_optimization = self._calculate_rhetorical_neurodivergent_optimization(
        ...
        result = DualSystemResult(
            ...
            neurodivergent_enhancement=enhanced_result.neurodivergent_enhancement + rhetorical_optimization,
            processing_time=processing_time,
            confidence_score=enhanced_result.confidence_score,
            integrated_response=enhanced_result.integrated_response + f"\n\nRhetorical Analysis: {rhetorical_analysis['overall_effectiveness']:.3f} effectiveness"
        )
        
        logger.info(f"ðŸŽ­ Rhetorical processing complete:")
        logger.info(f"   Persuasive effectiveness: {rhetorical_analysis.get('overall_effectiveness', 0):.3f}")
    ...
    async def _comprehensive_rhetorical_analysis(self, text: str, context: Dict[str, Any]) -> Dict[str, Any]:
        """Perform comprehensive rhetorical analysis"""
        
        # Classical rhetorical analysis (Ethos, Pathos, Logos)
        classical_analysis = await self.classical_processor.analyze_classical_rhetoric(text)
        ...
        cultural_analysis = await self.cultural_processor.analyze_cross_cultural_rhetoric(text, target_culture)
        ...
        persuasive_strategies = self._identify_persuasive_strategies(text, classical_analysis)
    ...
    def _determine_rhetorical_mode(self, text: str) -> RhetoricalMode:
        ...
        mode_indicators = {
            RhetoricalMode.DELIBERATIVE: [r"should", r"policy", r"future", r"action", r"decision"],
            RhetoricalMode.JUDICIAL: [r"guilty", r"innocent", r"evidence", r"trial", r"justice"],
            RhetoricalMode.EPIDEICTIC: [r"celebrate", r"honor", r"praise", r"condemn", r"virtue"],
            RhetoricalMode.DIALECTICAL: [r"question", r"explore", r"consider", r"examine", r"dialogue"],
            RhetoricalMode.SOPHISTIC: [r"complex", r"nuanced", r"sophisticated", r"elaborate"],
            RhetoricalMode.PROPHETIC: [r"vision", r"future", r"inspire", r"transform", r"imagine"]
        }
    ...
    def _calculate_overall_rhetorical_effectiveness(self, classical: Dict[str, Any],
                                                  modern: Dict[str, Any],
                                                  cultural: Dict[str, Any]) -> float:
        """Calculate overall rhetorical effectiveness"""
        ...
        overall = (classical_effectiveness * classical_weight +
                  modern_effectiveness * modern_weight +
                  cultural_effectiveness * cultural_weight)
        
        return min(overall, 1.0)
    
    def _identify_persuasive_strategies(self, text: str, classical_analysis: Dict[str, Any]) -> List[str]:
    ...
    def _assess_audience_adaptation(self, text: str, context: Dict[str, Any]) -> float:
        ...
        audience_markers = [
            r"you understand", r"as you know", r"your experience",
            r"like you", r"people like us", r"in your situation"
        ]
        ...
        if "target_audience" in context:
            ...
            if audience == "academic" and re.search(r"research|study|evidence", text, re.IGNORECASE):
                adaptation_score += 0.2
            elif audience == "general" and re.search(r"simple|easy|clear", text, re.IGNORECASE):
                adaptation_score += 0.2
            elif audience == "professional" and re.search(r"industry|business|efficiency", text, re.IGNORECASE):
                adaptation_score += 0.2
        
        return min(adaptation_score, 1.0)
    
    def _calculate_rhetorical_complexity(self, classical: Dict[str, Any],
                                       modern: Dict[str, Any],
                                       cultural: Dict[str, Any]) -> float:
        ...
        cultural_complexity = min((cultural_barriers + cultural_adaptations) * 0.05, 0.3)
        
        total_complexity = classical_complexity + modern_complexity + cultural_complexity
        
        return min(total_complexity, 1.0)
    
    def _integrate_rhetorical_insights(self, base_result: DualSystemResult,
                                     rhetorical_analysis: Dict[str, Any]) -> DualSystemResult:
        ...
        enhanced_perceptual = {
            **base_result.perceptual_analysis,
            "cultural_adaptation": rhetorical_analysis["cultural_analysis"]["cultural_adaptation"],
            "cross_cultural_effectiveness": rhetorical_analysis["cultural_analysis"]["cross_cultural_effectiveness"],
            "audience_adaptation": rhetorical_analysis["audience_adaptation"]
        }
        
        # Enhanced integrated response
        enhanced_response = base_result.integrated_response + f"\nRhetorical effectiveness: {rhetorical_analysis['overall_effectiveness']:.3f}"
        enhanced_response += f", Tradition: {rhetorical_analysis['rhetorical_tradition'].value}"
        enhanced_response += f", Complexity: {rhetorical_analysis['rhetorical_complexity']:.3f}"
    ...
    def _calculate_rhetorical_neurodivergent_optimization(self, rhetorical_analysis: Dict[str, Any],
        ...
        if context.get("neurodivergent_type") == "ADHD":
            ...
            num_devices = len(rhetorical_analysis["classical_analysis"].get("rhetorical_devices", []))
        ...
        # Autism optimization from rhetorical structure
            ...
            argument_strength = rhetorical_analysis["modern_analysis"].get("argument_strength", 0)
        ...
        # General neurodivergent benefits
            ...
            balance_score = rhetorical_analysis["classical_analysis"]["rhetorical_balance"]["balance_score"]
    ...
    def _update_rhetorical_stats(self, rhetorical_analysis: Dict[str, Any], optimization: float):
        ...
        self.rhetorical_stats["average_persuasive_effectiveness"] = (
            (current_avg * (n - 1) + new_effectiveness) / n
        )
        
        # Count cultural adaptations and fallacies
        adaptations = len(rhetorical_analysis["cultural_analysis"].get("suggested_adaptations", []))
        self.rhetorical_stats["cultural_adaptations_suggested"] += adaptations
        
        fallacies = len(rhetorical_analysis["modern_analysis"].get("fallacies_detected", []))
    ...
    def get_rhetorical_research_report(self) -> Dict[str, Any]:
        ...
        rhetorical_report = {
            ...
            "rhetorical_insights": {
                "most_common_tradition": max(
                    self.rhetorical_stats["rhetorical_traditions_detected"],
                    key=self.rhetorical_stats["rhetorical_traditions_detected"].get
                ) if self.rhetorical_stats["rhetorical_traditions_detected"] else "None",
                "average_persuasive_effectiveness": self.rhetorical_stats["average_persuasive_effectiveness"],
