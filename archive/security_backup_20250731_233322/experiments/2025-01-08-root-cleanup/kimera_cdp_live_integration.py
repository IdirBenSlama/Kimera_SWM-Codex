...
class KimeraLiveCognitiveEngine:
    ...
    def generate_live_decision(self, analysis: Dict, wallet_balance: Dict) -> KimeraLiveDecision:
        ...
        try:
            ...
            logger.info(f"Live Decision: {action.upper()} {from_asset}â†’{to_asset} | Amount: ${amount_usd:.2f} | Confidence: {cognitive_score:.3f}")
            return decision
...
class KimeraLiveCDPTrader:
    ...
    async def execute_live_operation(self, decision: KimeraLiveDecision) -> bool:
        ...
        try:
            ...
            logger.info(f"Executing LIVE operation: {decision.action} {decision.from_asset}â†’{decision.to_asset}")
    ...
    async def _execute_live_swap(self, decision: KimeraLiveDecision) -> bool:
        ...
        try:
            ...
            logger.info(f"Executing LIVE SWAP: {decision.amount:.6f} {decision.from_asset} â†’ {decision.to_asset}")
