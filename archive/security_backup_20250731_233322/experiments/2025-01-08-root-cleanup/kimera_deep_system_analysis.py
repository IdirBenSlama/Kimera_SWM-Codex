...
class KimeraDeepAnalyzer:
    ...
    def generate_report(self):
        ...
        print("\nScientific Integrity:")
        print(f"  Thermodynamics: {'âœ“' if thermo.get('physics_compliant', False) else 'âœ—'}")
        print(f"  Quantum: {'âœ“' if quantum.get('heisenberg_satisfied', False) else 'âœ—'}")
        print(f"  Conservation: {'âœ“' if diffusion.get('conservation_satisfied', False) else 'âœ—'}")
