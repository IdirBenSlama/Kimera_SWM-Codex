...
import backend.trading.autonomous_kimera_trader as base_trader
from backend.trading.autonomous_kimera_trader import KimeraAutonomousTrader, CognitiveSignal, TradingStrategy, MarketRegime
    ...
    try:
        ...
        if real_balance > 0:
            ...
            if real_balance >= 1.0:
                ...
                print(f"📊 Recommended allocation per trade: €{real_balance * 0.2:.2f} (20%)")
            else:
