...
class ConservativeTradeTest:
    ...
    async def initialize_system(self) -> bool:
        ...
        try:
            ...
            from backend.trading.core.live_trading_manager import LiveTradingManager, LiveTradingConfig, TradingMode, TradingPhase
    ...
    async def verify_system_status(self) -> bool:
        ...
        try:
            ...
            from backend.trading.core.live_trading_manager import LiveTradingConfig
            config = LiveTradingConfig()
